...
namespace ForLeaseEngine {
    namespace Components {
        SpriteText::SpriteText(Entity& owner, const std::string& font) : Component(owner, ComponentType::SpriteText, ComponentType::Transform), TextFont(font) {}
        SpriteText::SpriteText(Entity& owner, const std::string& font, const std::string& text, const Color& textColor)
                              : Component(owner, ComponentType::SpriteText, ComponentType::Transform), Text(text), TextColor(textColor), TextFont(font) {}
